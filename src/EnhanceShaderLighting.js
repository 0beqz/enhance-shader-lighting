...
const lights_fragment_maps = THREE.ShaderChunk.lights_fragment_maps.replace(
  "USE_LIGHTMAP",
  "false"
);
const lightmap_fragment = THREE.ShaderChunk.lightmap_fragment.replace(
  "USE_LIGHTMAP",
  "false"
);
...
export function enhanceShaderLighting(
  ...
  if (
    shader.defines &&
    shader.fragmentShader.includes("#define ENHANCE_SHADER_LIGHTING")
  )
    return;
