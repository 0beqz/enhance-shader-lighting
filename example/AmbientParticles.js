...
export function createAmbientDust() {
    ...
    let ambientParticles = new THREE.InstancedMesh(new THREE.PlaneBufferGeometry(1, 1, 1), ambientParticlesMat, count);
    ...
    for (let dustParticleZone of dustParticleZones) {
...
function patchAmbientParticles(shader) {
    ...
    shader.vertexShader = "varying float particleDepth;\n" +
        "uniform float time;\n" +
        shader.vertexShader
            .replace(
    ...
    shader.fragmentShader = "varying float particleDepth;\n" +
