...
gltfFiles.forEach((f) => {
  const cmds = [
    ...
    `gltf-transform resize --width 2048 --height 2048 ${f.replace(
      ".glb",
      ""
    )}.optimized.glb ${f.replace(".glb", "")}.optimized.glb`,
    `gltf-transform merge ${f.replace(".glb", "")}.optimized.glb ${f.replace(
      ".glb",
      ""
    )}.optimized.glb`,
    `gltf-transform prune ${f.replace(".glb", "")}.optimized.glb ${f.replace(
      ".glb",
      ""
    )}.optimized.glb`,
    `gltf-transform draco ${f.replace(".glb", "")}.optimized.glb ${f.replace(
      ".glb",
      ""
    )}.optimized.glb`,
  ];
